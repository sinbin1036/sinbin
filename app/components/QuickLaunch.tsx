...
//           <p className="text-sm font-medium text-stone-700 dark:text-stone-100">아직 등록된 바로가기가 없어요.</p>
...
//             <a href={item.href} target="_blank" rel="noreferrer" className="flex flex-1 flex-col items-center justify-center gap-2">
...
//                 </h3>
//                 <p className="text-xs text-stone-500 dark:text-stone-400">라벨, URL, 설명을 입력하세요. URL로 파비콘을 자동 가져옵니다.</p>
//               </div>
//               <button
//                 type="button"
//                 onClick={() => {
